...
public class SubscribedUserService {
    ...
    public SubscribedUser createSubscribedUser(SubscribedUserDTO subscribedUserDTO) {
        ...
        subscribedUser.setRegistrationDate(subscribedUserDTO.getRegistrationDate());
        ...
        LocalDate expiryDate = subscribedUserDTO.getRegistrationDate().plusMonths(plan.getNumberOfMonths());
